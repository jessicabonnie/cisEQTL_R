...
results <- read.table("/home/jkb4y/work/data/2012Feb1/intersect_fam_uk/hg19/intersect_assoc.assoc.logistic",T)
return(results)
}

# manhattan plot using base graphics
manhattan <- function(dataframe, colors=c("gray10", "gray50"), ymax="max", limitchromosomes=1:23, suggestiveline=-log10(1e-5), genomewideline=-log10(3.5e-7), annotate=NULL, ...) {
